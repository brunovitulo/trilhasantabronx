  ...
  },
  {
    ...
    subtasks: [
      ...
      },
      {
        ...
        questions: [
          { question: "O que é disfunção erétil?", options: ["Quando o homem perde completamente o desejo sexual por causas hormonais.", "Quando o homem tem dificuldade de ter ou manter o pênis ereto.", "Quando o homem sente dor durante a ereção e precisa interromper.", "Quando o homem ejacula antes do esperado durante a relação."], correctIndex: 1 },
          { question: "Quando a dificuldade de ereção parece estar mais avançada, qual produto foi apresentado como solução mecânica?", options: ["Anel peniano simples.", "Cápsula estimulante de uso contínuo.", "Bomba peniana.", "Sachê energético afrodisíaco."], correctIndex: 2 },
          { question: "O que caracteriza a ejaculação precoce?", options: ["Quando o homem demora muito tempo para atingir o orgasmo.", "O homem chegar ao orgasmo rápido demais.", "Quando o homem não consegue ejacular durante a relação.", "Quando o homem perde a ereção logo após penetrar."], correctIndex: 1 },
          { question: "Como o spray retardante ajuda o homem a durar mais?", options: ["Aumentando a circulação sanguínea no pênis.", "Bloqueando completamente a ejaculação durante a relação.", "Reduzindo a sensibilidade da glande.", "Estimulando a produção de testosterona."], correctIndex: 2 },
          { question: "A falta de libido pode estar ligada a quais fatores?", options: ["Apenas ao envelhecimento natural do corpo.", "Cansaço, estresse, rotina, queda de vitaminas ou falta de energia.", "Apenas a fatores hormonais que exigem tratamento cirúrgico.", "Somente a problemas no relacionamento do casal."], correctIndex: 1 },
          { question: "Qual é a diferença básica entre cápsulas de libido e sachês estimulantes?", options: ["Cápsulas são mais ligadas a uso contínuo; sachês têm proposta mais imediata.", "Sachês têm efeito prolongado de até 30 dias; cápsulas agem em poucos minutos.", "Cápsulas servem apenas para mulheres; sachês servem apenas para homens.", "Não existe diferença prática entre eles, só muda a embalagem."], correctIndex: 0 },
          { question: "Por que excitantes podem ajudar na dificuldade de chegar ao orgasmo?", options: ["Porque podem aumentar sensibilidade e gerar sensações como aquecer, esfriar ou formigar.", "Porque eliminam qualquer bloqueio emocional do cliente na hora do ato.", "Porque aumentam o tempo de duração da relação automaticamente.", "Porque substituem a necessidade de preliminares."], correctIndex: 0 },
          { question: "Antes de indicar um vibrador para uma mulher, qual pergunta é essencial?", options: ["Se ela prefere usar de manhã ou à noite.", "Se ela sente mais prazer no clitóris, na penetração ou nos dois.", "Se ela quer um modelo recarregável ou que funcione com pilha.", "Se ela já comprou algum brinquedo em outra loja antes."], correctIndex: 1 },
          { question: "Quais são duas causas citadas para dor na penetração vaginal?", options: ["Falta de lubrificação e vaginismo.", "Diferença de tamanho do parceiro e diferença de idade do casal.", "Excesso de uso de excitantes durante o ato.", "Posição escolhida na relação e horário do dia."], correctIndex: 0 },
          { question: "Qual produto foi apresentado como tratamento para grande ressecamento vaginal?", options: ["Lubrificante de uso pontual durante a relação.", "Hidratante vaginal.", "Excitante feminino com efeito de aquecimento.", "Adstringente em gel para uso íntimo."], correctIndex: 1 },
          { question: "Por que o lubrificante é fundamental no sexo anal?", options: ["Porque o ânus não possui lubrificação própria.", "Porque facilita a higienização da região depois do ato.", "Porque ajuda a manter a ereção do parceiro por mais tempo.", "Porque permite dispensar o uso de preservativo com segurança."], correctIndex: 0 },
          { question: "Qual é a função do plug anal no contexto de preparação?", options: ["Massagear externamente a região para relaxar a musculatura.", "Preparar e ajudar na dilatação gradual antes da penetração.", "Estimular o ponto P do homem sem necessidade de penetração.", "Servir como brinquedo principal durante toda a relação."], correctIndex: 1 },
          { question: "Qual é a função básica do anel peniano?", options: ["Apertar levemente o pênis para ajudar a segurar sangue na região.", "Aumentar permanentemente o diâmetro e o tamanho do pênis.", "Estimular a próstata por vibração interna durante a relação.", "Aquecer a glande para aumentar a sensibilidade do homem."], correctIndex: 0 },
          { question: "Qual diferencial alguns modelos de anel peniano possuem?", options: ["Material biodegradável que dissolve sozinho depois do uso.", "Vibrador para estimular o clitóris durante a penetração.", "Aplicador automático de lubrificante embutido na peça.", "Sensor que mede e exibe a duração da relação."], correctIndex: 1 },
          { question: "Para que serve o anestésico de garganta?", options: ["Reduzir desconforto e ânsia no oral profundo.", "Tratar afta e inflamação dentro da boca.", "Anestesiar o pênis do parceiro durante o sexo oral.", "Aumentar a salivação para facilitar o oral."], correctIndex: 0 },
          { question: "Como o anestésico de garganta normalmente é aplicado?", options: ["Como pastilha para chupar antes do oral.", "Como spray no fundo da garganta.", "Como gel passado nos lábios.", "Como enxaguante bucal usado antes do ato."], correctIndex: 1 },
          { question: "Qual é a proposta do perfume com feromônio?", options: ["Ser um perfume com apelo de atração e desejo.", "Ser um repelente que mascara odores naturais do corpo.", "Ser um perfume que neutraliza o cheiro de excitantes íntimos.", "Ser um aromatizante específico para a região íntima."], correctIndex: 0 },
          { question: "Como a consultora pode explicar de forma simples o perfume com feromônio?", options: ["“É um excitante líquido que se aplica diretamente nos lábios.”", "“É um perfume para usar no corpo com proposta de despertar mais desejo.”", "“É um óleo de massagem com aroma marcante e duradouro.”", "“É um spray íntimo que melhora o cheiro natural do corpo.”"], correctIndex: 1 },
          { question: "Como funcionam as bolinhas explosivas?", options: ["São cápsulas ingeridas que aumentam a libido aos poucos.", "São introduzidas no canal e liberam óleo com sensação durante a penetração.", "São colocadas na ponta do pênis para retardar a ejaculação.", "São aplicadas externamente no clitóris em forma de gel."], correctIndex: 1 },
          { question: "Qual dúvida comum sobre bolinhas explosivas a consultora deve saber responder?", options: ["Se a bolinha fica presa no canal.", "Se a bolinha precisa de receita ou indicação médica.", "Se a bolinha também pode ser usada por homens.", "Se a bolinha tem prazo de validade depois de aberta."], correctIndex: 0 },
          { question: "O que acontece quando a vela para massagem é acesa?", options: ["Ela vira óleo para massagem.", "Ela libera somente aroma terapêutico no ambiente.", "Ela aquece e endurece para servir como brinquedo íntimo.", "Ela derrete e cria uma película protetora sobre a pele."], correctIndex: 0 },
          { question: "Qual é uma dúvida comum sobre vela para massagem?", options: ["Se ela vai queimar a pele como uma vela comum.", "Se ela mancha lençóis e roupas íntimas durante o uso.", "Se o óleo é seguro para massagear áreas mais sensíveis.", "Se o aroma fica impregnado no ambiente por vários dias."], correctIndex: 0 },
          { question: "Para que serve o colar de pérolas no contexto íntimo?", options: ["Estimular regiões íntimas com toque diferente.", "Servir como acessório decorativo para fotos sensuais.", "Funcionar como amuleto que aumenta a libido do casal.", "Marcar pontos sensíveis do corpo durante a massagem."], correctIndex: 0 },
          { question: "Uma forma de usar o colar de pérolas é:", options: ["Enrolar no pênis ou na mão para masturbação.", "Usar como bracelete íntimo durante toda a relação.", "Inserir uma pérola por vez no canal vaginal.", "Manter pendurado no pescoço durante o sexo oral."], correctIndex: 0 },
          { question: "O que a capa peniana faz?", options: ["Aumenta volume/tamanho durante o uso.", "Aumenta a circulação sanguínea e a firmeza do pênis.", "Estimula a produção natural de testosterona.", "Reduz a sensibilidade da glande para o homem durar mais."], correctIndex: 0 },
          { question: "Qual informação importante deve ser dita sobre capa peniana?", options: ["Ela substitui a camisinha em qualquer situação.", "Ela não substitui camisinha e não garante proteção.", "Ela só pode ser usada uma única vez e depois descartada.", "Ela é considerada um produto farmacêutico controlado."], correctIndex: 1 },
        ],
      },
      {
        id: "dores.checklist",
    ...
    subtasks: [
      ...
      },
      {
        ...
        questions: [
          ...
          { question: "Qual cuidado deve ser informado em relação a estimulantes sexuais?", options: ["Podem ser usados sem restrição por qualquer pessoa.", "Gestantes, lactantes e crianças não devem usar.", "Quanto maior a quantidade usada, melhor o resultado.", "Todos devem ser usados diariamente, mesmo os de dose única."], correctIndex: 1 },
          { question: "Explique a diferença entre um estimulante sexual de uso pontual e um estimulante em cápsulas de uso contínuo.", expectedAnswer: "Pontual (sachê/energético) age na hora para uma ocasião; contínuo (cápsulas) é tomado por mais tempo para melhorar libido, disposição e desempenho de forma gradual." },
          { question: "Qual é a principal função do retardante masculino?", options: ["Reduzir parte da sensibilidade para ajudar no controle da ejaculação.", "Aumentar o tamanho do pênis permanentemente.", "Funcionar como lubrificante beijável.", "Substituir um estimulante sexual em cápsula."], correctIndex: 0 },
          { question: "Qual é a diferença entre retardante e produto vasodilatador masculino?", options: ["O retardante ajuda a durar mais; o vasodilatador tem foco maior em circulação e ereção.", "Os dois têm exatamente a mesma função.", "O retardante é para mulher, e o vasodilatador é para homem.", "O vasodilatador sempre tem efeito anestésico."], correctIndex: 0 },
          { question: "Como responder a objeção “isso vai me fazer brochar?”", options: ["Prometer que nunca haverá perda de ereção em nenhum caso.", "Explicar que a proposta é reduzir sensibilidade, mas sem vender como garantia absoluta.", "Dizer que quanto mais produto usar, menor o risco.", "Indicar usar junto com qualquer outro produto sem avaliar necessidade."], correctIndex: 1 },
          { question: "Explique quando você indicaria apenas um retardante e quando faria sentido falar também de um produto para ereção.", expectedAnswer: "Retardante quando a queixa é durar pouco; produto para ereção/vasodilatador quando a queixa envolve firmeza/manutenção da ereção. Pode combinar quando faz sentido, sem prometer milagre." },
          { question: "Qual pergunta deve ser feita antes de indicar um lubrificante?", options: ["“Você vai usar com preservativo, sex toy, anal, oral ou no banho?”", "“Você quer qualquer um?”", "“Você quer o mais cheiroso?”", "“Você prefere não saber a base?”"], correctIndex: 0 },
          { question: "Qual diferença entre base água e base silicone está correta?", options: ["Base água costuma ser mais versátil; silicone dura mais e resiste melhor à água, mas exige cuidado com preservativo e sex toy.", "Base silicone é sempre beijável.", "Base água nunca pode ser usada com preservativo.", "Não existe diferença relevante entre as bases."], correctIndex: 0 },
          { question: "Quando um lubrificante beijável faz mais sentido?", options: ["Quando a pessoa quer lubrificação com possibilidade de brincadeiras e sexo oral, conforme indicação do produto.", "Quando a pessoa quer retardar ejaculação.", "Quando busca contração vaginal.", "Quando quer aumentar ereção por vasodilatação."], correctIndex: 0 },
          { question: "Explique como você escolheria entre lubrificante à base de água, lubrificante de silicone, lubrificante anal e lubrificante beijável.", expectedAnswer: "Água: versátil, compatível com preservativo e sex toys. Silicone: dura mais, resiste à água, exige cuidado com preservativo/sex toy de silicone. Anal: mais espesso/durável. Beijável: sabor e seguro para oral." },
          { question: "Qual explicação é correta sobre anestésico anal?", options: ["Ajuda a reduzir desconforto/sensibilidade, mas não substitui lubrificante, calma e cuidado.", "Elimina qualquer risco de dor ou machucado.", "Serve para aumentar libido.", "Funciona como perfume corporal."], correctIndex: 0 },
          { question: "Qual é a diferença entre anestésico anal e spray de garganta?", options: ["Um é voltado para desconforto anal; o outro ajuda a reduzir ânsia no oral profundo.", "Os dois têm exatamente a mesma aplicação.", "Os dois são estimulantes ingeríveis.", "Ambos funcionam como lubrificantes."], correctIndex: 0 },
          { question: "Qual orientação deve acompanhar o uso de anestésico anal?", options: ["Usar lubrificante, ir com calma e respeitar limites do corpo.", "Dispensar lubrificante.", "Usar para não sentir absolutamente nada.", "Continuar mesmo se houver dor intensa."], correctIndex: 0 },
          { question: "Explique como indicar anestésico anal sem fazer a cliente acreditar que ele substitui lubrificante ou cuidado.", expectedAnswer: "Posicionar como auxílio para reduzir desconforto/sensibilidade; reforçar uso com lubrificante adequado, ir com calma, respeitar limites e não continuar com dor intensa." },
        ],
      },
      {
      ...
      },
      {
        ...
        passingScore: 70,
        questions: [
          { question: "Qual é a explicação correta sobre capa peniana?", options: ["É um acessório usado sobre o pênis para aumentar volume, tamanho ou estímulo durante o uso.", "É um preservativo comum com proteção garantida.", "É um produto que aumenta o tamanho do pênis permanentemente.", "É um gel para aplicar na glande antes da relação."], correctIndex: 0 },
          { question: "Por que modelos com alça escrotal costumam ser recomendados?", options: ["Porque substituem a camisinha.", "Porque ajudam a manter a capa mais firme durante a penetração.", "Porque aumentam permanentemente o tamanho do pênis.", "Porque dispensam qualquer cuidado de encaixe."], correctIndex: 1 },
          { question: "Qual é um cuidado obrigatório ao vender capa peniana?", options: ["Explicar que ela pode substituir preservativo.", "Reforçar que ela não é camisinha e não deve ser vendida como proteção.", "Dizer que qualquer modelo serve para qualquer pessoa.", "Indicar sempre o modelo maior, independentemente da experiência."], correctIndex: 1 },
          { question: "Explique como diferenciar uma capa peniana fechada, uma vazada e uma com alça escrotal.", expectedAnswer: "Fechada cobre a glande e aumenta volume; vazada deixa a glande livre e o homem mantém sensibilidade; com alça escrotal prende no saco e fica mais firme durante a penetração." },
          { question: "Qual é a principal função do plug anal?", options: ["Preparar e dilatar gradualmente a região anal para facilitar a penetração.", "Substituir o lubrificante anal.", "Anestesiar completamente a região.", "Ser usado sem base para entrar totalmente."], correctIndex: 0 },
          { question: "Qual orientação é essencial para indicar plug anal com segurança?", options: ["Começar sempre pelo maior tamanho.", "Usar plug com base segura e lubrificante adequado.", "Evitar lubrificante para o plug não escorregar.", "Empurrar o plug inteiro para dentro."], correctIndex: 1 },
          { question: "Como diferenciar plug de silicone e plug de metal?", options: ["Silicone tende a ser mais confortável, enquanto metal é mais escorregadio e pode permitir sensação térmica.", "Silicone é sempre para avançados, e metal é sempre para iniciantes.", "Metal não pode ser higienizado.", "Não existe diferença prática entre materiais."], correctIndex: 0 },
          { question: "Explique como você indicaria plug anal para uma pessoa iniciante, incluindo tamanho, material e cuidado de uso.", expectedAnswer: "Tamanho pequeno, material confortável (geralmente silicone), com base segura, uso com lubrificante adequado, ir devagar e respeitar limites." },
          { question: "Qual é a principal função do anel peniano simples?", options: ["Prender parte da circulação na base do pênis, ajudando na ereção mais firme e prolongada.", "Funcionar como preservativo.", "Aumentar o tamanho do pênis definitivamente.", "Ser aplicado como gel na glande."], correctIndex: 0 },
          { question: "Qual vantagem os modelos vibratórios podem ter?", options: ["Estimular o clitóris durante a penetração, além de ajudar na experiência do homem.", "Substituir todos os tipos de vibradores.", "Funcionar como estimulante ingerível.", "Contrair o canal vaginal."], correctIndex: 0 },
          { question: "Qual cuidado é importante ao orientar o uso de anel peniano?", options: ["Usar apertado pelo máximo de tempo possível.", "Não usar apertado demais nem por tempo excessivo.", "Usar como camisinha.", "Indicar qualquer tamanho sem avaliar conforto."], correctIndex: 1 },
          { question: "Explique como vender um anel peniano vibratório para um casal, mostrando benefício para o homem e para a parceira.", expectedAnswer: "Para o homem: ereção mais firme e duradoura. Para a parceira: estímulo no clitóris durante a penetração. Reforçar conforto e tempo de uso adequado." },
          { question: "Qual é a melhor abordagem ao vender produtos sado/BDSM?", options: ["Entender se o cliente quer algo leve, casual, resistente, intenso ou mais completo.", "Indicar sempre o acessório mais forte.", "Falar apenas do preço.", "Evitar explicar material e resistência."], correctIndex: 0 },
          { question: "Qual diferença faz sentido entre algema de metal com pelúcia e algema de couro/luxo?", options: ["A de pelúcia costuma ser mais casual; a de couro/luxo tende a ser mais confortável e resistente.", "A de metal é sempre mais confortável.", "A de couro sempre arrebenta com facilidade.", "Não existe diferença prática."], correctIndex: 0 },
          { question: "Qual ponto deve estar presente em qualquer orientação sobre produtos sado?", options: ["Consentimento, conforto, limites e segurança.", "Uso sem combinar limites.", "Escolha sempre pelo acessório mais intenso.", "Ignorar regulagem e material."], correctIndex: 0 },
          { question: "Explique como você diferenciaria um produto sado leve para iniciantes de um produto mais resistente/intenso.", expectedAnswer: "Leve: materiais macios (pelúcia, tecido), regulagem fácil, foco em brincadeira casual. Resistente/intenso: couro/luxo, maior durabilidade, indicado para quem já tem prática, sempre com consentimento e limites." },
          { question: "Qual é o principal diferencial de um masturbador masculino?", options: ["Textura interna e sensação simulada durante o uso.", "Aroma com feromônio.", "Contração vaginal.", "Uso como anel peniano."], correctIndex: 0 },
          { question: "Qual produto costuma ser indicado junto para melhorar a experiência com masturbador?", options: ["Lubrificante adequado.", "Adstringente feminino.", "Spray de garganta.", "Perfume com feromônio obrigatório."], correctIndex: 0 },
          { question: "Qual cuidado pós-uso é mais importante?", options: ["Higienizar e secar corretamente para preservar o material.", "Guardar molhado e fechado.", "Não lavar para manter a textura.", "Compartilhar sem higienização."], correctIndex: 0 },
          { question: "Explique como você venderia um masturbador masculino diferenciando modelo simples, realístico e automático.", expectedAnswer: "Simples: foco em textura interna básica, bom preço. Realístico: visual e sensação mais próximos do real. Automático: vibração/movimento próprio, experiência mais intensa." },
          { question: "Qual é a melhor lógica de venda para roupas sensuais?", options: ["Entender o estilo, a ocasião e a sensação que a cliente quer causar.", "Indicar sempre a peça mais ousada.", "Vender apenas pelo tamanho.", "Dizer que todas as peças vestem da mesma forma."], correctIndex: 0 },
          { question: "Qual pergunta ajuda mais na indicação de roupas sensuais?", options: ["“Você quer algo mais elegante, provocante, fantasia ou surpresa?”", "“Você quer qualquer peça que estiver disponível?”", "“Você quer só a cor mais barata?”", "“Você quer um produto para ereção?”"], correctIndex: 0 },
          { question: "Qual cuidado comercial é importante na categoria de roupas sensuais?", options: ["Explicar política de troca e higiene quando necessário.", "Prometer que qualquer tamanho serve.", "Dizer que conforto não importa.", "Ignorar estilo da cliente."], correctIndex: 0 },
          { question: "Explique como você ajudaria uma cliente a escolher uma peça sensual considerando estilo, conforto e ocasião.", expectedAnswer: "Perguntar ocasião (surpresa, fantasia, autoestima), estilo (elegante, provocante, fantasia), tamanho/conforto e orientar política de troca/higiene." },
          { question: "Qual é a proposta principal do pênis realístico?", options: ["Simular visual e sensação de uma prótese peniana, podendo ter ventosa, vibração, aquecimento ou movimento.", "Funcionar como perfume com feromônio.", "Ser usado como anel peniano.", "Reduzir ânsia no oral."], correctIndex: 0 },
          { question: "Qual pergunta ajuda mais na indicação do pênis realístico?", options: ["“Você quer realismo simples, ventosa, vibração, aquecimento ou movimento automático?”", "“Você quer apenas lubrificante?”", "“Você quer uma algema?”", "“Você quer uma cápsula?”"], correctIndex: 0 },
          { question: "Qual diferencial da ventosa no pênis realístico?", options: ["Permite fixar em superfícies lisas para uso com mãos livres ou posições diferentes.", "Aumenta libido automaticamente.", "Serve como preservativo.", "Reduz sensibilidade da glande."], correctIndex: 0 },
          { question: "Explique como diferenciar uma prótese realística simples de uma prótese com vibração, aquecimento ou movimento automático.", expectedAnswer: "Simples: foco no visual e na sensação realística, sem função extra. Com vibração/aquecimento/movimento: agrega tecnologia para experiência mais intensa e próxima do real, com preço mais alto." },
        ],
      },
      {
      ...
      },
      {
        ...
        passingScore: 70,
        questions: [
          { question: "Qual é a principal característica do vibrador Rabbit?", options: ["Estimular internamente e externamente ao mesmo tempo, geralmente ponto G e clitóris.", "Ser apenas um mini vibrador externo.", "Funcionar como lubrificante.", "Ser usado exclusivamente por casal durante penetração."], correctIndex: 0 },
          { question: "Para qual cliente o Rabbit faz mais sentido?", options: ["Cliente que gosta de penetração e também quer estímulo no clitóris.", "Cliente que não gosta de nenhum estímulo interno.", "Cliente que procura apenas perfume.", "Cliente que quer um produto para ejaculação precoce."], correctIndex: 0 },
          { question: "Qual cuidado a atendente deve ter antes de indicar um Rabbit?", options: ["Considerar tamanho, formato, material e experiência da cliente.", "Indicar sempre o maior modelo.", "Falar apenas da cor.", "Dizer que todos os rabbits encaixam igual."], correctIndex: 0 },
          { question: "Explique a diferença entre um vibrador Rabbit e um sugador de clitóris.", expectedAnswer: "Rabbit estimula interna (ponto G) e externamente (clitóris) ao mesmo tempo. Sugador foca só no clitóris, usando sucção/pulsação." },
          { question: "Qual é a proposta principal do sugador de clitóris?", options: ["Estimular o clitóris de forma intensa por sucção, pulsação ou tecnologia similar.", "Estimular apenas o ponto G por penetração profunda.", "Funcionar como lubrificante íntimo.", "Ser usado como capa peniana."], correctIndex: 0 },
          { question: "Qual cliente tem maior chance de gostar do sugador de clitóris?", options: ["Cliente que sente mais prazer com estímulo externo no clitóris.", "Cliente que quer apenas adstringente.", "Cliente que procura cápsulas de libido.", "Cliente que quer fantasia sensual."], correctIndex: 0 },
          { question: "Como diferenciar modelos simples e completos de sugador?", options: ["Alguns focam só na sucção; outros combinam sucção, língua, vibração ou penetração.", "Todos têm exatamente a mesma função e potência.", "Modelos completos são perfumes.", "Modelos simples são lubrificantes."], correctIndex: 0 },
          { question: "Explique como você indicaria um sugador de clitóris para uma cliente que relata dificuldade de chegar ao orgasmo.", expectedAnswer: "Apresentar como estímulo externo intenso no clitóris, com sucção/pulsação; explicar uso com lubrificante, começar em intensidade mais baixa e respeitar o próprio ritmo." },
          { question: "Qual é o principal diferencial do vibrador de calcinha?", options: ["Discrição e possibilidade de uso preso à calcinha, muitas vezes com controle.", "Penetração profunda obrigatória.", "Função de lubrificante.", "Ação adstringente."], correctIndex: 0 },
          { question: "Quando o vibrador de calcinha costuma ser bem indicado?", options: ["Para casal que quer brincadeira discreta com controle à distância.", "Para quem quer plug anal grande.", "Para quem quer retardante masculino.", "Para quem quer perfume com feromônio."], correctIndex: 0 },
          { question: "Qual erro deve ser evitado na venda do vibrador de calcinha?", options: ["Prometer controle ilimitado sem verificar se o modelo realmente possui essa função.", "Explicar como fixa na calcinha.", "Falar sobre bateria.", "Explicar que é discreto."], correctIndex: 0 },
          { question: "Explique como apresentar o vibrador de calcinha para um casal que quer uma brincadeira discreta.", expectedAnswer: "Mostrar discrição, fixação na calcinha e controle (pelo parceiro ou aplicativo, dependendo do modelo), confirmando se o modelo realmente permite o tipo de controle prometido." },
          { question: "Qual é a proposta principal da máquina de sexo?", options: ["Simular movimento automático de penetração.", "Funcionar como perfume com feromônio.", "Ser um anel peniano simples.", "Reduzir ânsia no oral."], correctIndex: 0 },
          { question: "Para qual cliente a máquina de sexo faz mais sentido?", options: ["Cliente que busca uma experiência intensa, automática e mais realística.", "Cliente que quer algo extremamente discreto e pequeno.", "Cliente que quer apenas lubrificante neutro.", "Cliente que quer roupa sensual."], correctIndex: 0 },
          { question: "Qual cuidado é importante na venda da máquina de sexo?", options: ["Explicar tamanho, potência, modo de uso e necessidade de lubrificante.", "Dizer que é igual a mini vibrador.", "Não falar sobre intensidade.", "Indicar sem entender a experiência da cliente."], correctIndex: 0 },
          { question: "Explique como diferenciar uma máquina de sexo de um pênis realístico comum.", expectedAnswer: "Máquina tem movimento automático de penetração, é mais intensa e exige espaço e lubrificação. Pênis realístico é manual ou com ventosa, sem movimento próprio." },
          { question: "Qual é a proposta do vibrador de casal?", options: ["Ser usado durante a relação para estimular os dois ao mesmo tempo.", "Ser usado apenas como perfume.", "Funcionar como anel peniano simples.", "Ser um estimulante em cápsula."], correctIndex: 0 },
          { question: "Qual é o principal argumento de venda do vibrador de casal?", options: ["Ele permite estímulo durante a penetração, podendo beneficiar o casal.", "Ele substitui todos os outros produtos íntimos.", "Ele não precisa de encaixe ou explicação.", "Ele é indicado somente para uso individual."], correctIndex: 0 },
          { question: "Qual detalhe técnico importa na categoria vibrador de casal?", options: ["Formato, encaixe, vibração, controle e conforto durante a penetração.", "Apenas a cor.", "Apenas o nome.", "Apenas o tamanho da embalagem."], correctIndex: 0 },
          { question: "Explique como vender um vibrador de casal para quem nunca usou brinquedos na relação.", expectedAnswer: "Reduzir medo: produto pensado para ser usado junto, durante a penetração, beneficiando os dois. Explicar formato/encaixe, controle e conforto, começando em intensidade baixa." },
          { question: "Qual é o diferencial do vibrador de aplicativo?", options: ["Controle pelo celular, podendo permitir uso próximo ou à distância, dependendo do modelo.", "Ser sempre descartável.", "Funcionar como lubrificante.", "Ser uma roupa sensual."], correctIndex: 0 },
          { question: "Qual cuidado é necessário ao falar de distância?", options: ["Verificar se o modelo permite longa distância ou apenas controle próximo.", "Prometer controle de qualquer lugar para todos os modelos.", "Não explicar o uso do aplicativo.", "Dizer que não precisa de bateria."], correctIndex: 0 },
          { question: "Qual pergunta ajuda na indicação do vibrador de aplicativo?", options: ["“Você quer controlar perto ou quer uma brincadeira mesmo à distância?”", "“Você quer adstringente?”", "“Você quer capa peniana?”", "“Você quer spray de garganta?”"], correctIndex: 0 },
          { question: "Explique como apresentar um vibrador de aplicativo para um casal que mora longe ou quer brincar à distância.", expectedAnswer: "Mostrar controle pelo celular, verificar se o modelo permite longa distância (não só próximo), explicar bateria, conexão e privacidade do aplicativo." },
          { question: "Qual é a principal proposta da varinha mágica?", options: ["Estimulação externa potente em clitóris e zonas erógenas.", "Penetração realística com ventosa.", "Contração vaginal.", "Uso como perfume."], correctIndex: 0 },
          { question: "Para quem a varinha costuma ser uma boa indicação?", options: ["Cliente que quer vibração forte e fácil de posicionar externamente.", "Cliente que quer apenas produto ingerível.", "Cliente que quer capa peniana.", "Cliente que quer algema."], correctIndex: 0 },
          { question: "Qual diferença da varinha para um mini vibrador?", options: ["A varinha costuma ter área de contato maior e vibração mais potente.", "O mini vibrador sempre é mais potente.", "São exatamente iguais.", "A varinha é um lubrificante."], correctIndex: 0 },
          { question: "Explique como indicar uma varinha mágica para uma cliente que quer estímulo externo forte.", expectedAnswer: "Apresentar como vibrador potente, com cabeça maior, ideal para estímulo externo intenso em clitóris e zonas erógenas; explicar modos, conforto e uso com lubrificante." },
          { question: "Qual é o diferencial do mini vibrador?", options: ["Ser pequeno, discreto e focado principalmente em estímulo externo.", "Ser uma máquina automática grande.", "Ser um lubrificante.", "Ser uma capa peniana."], correctIndex: 0 },
          { question: "Para qual cliente o mini vibrador faz mais sentido?", options: ["Cliente que quer algo discreto, fácil de guardar e usar no clitóris ou zonas erógenas.", "Cliente que quer penetração profunda realística obrigatória.", "Cliente que quer cápsulas de libido.", "Cliente que quer roupa sensual."], correctIndex: 0 },
          { question: "Qual cuidado a atendente deve ter ao indicar mini vibrador?", options: ["Não vender como produto para penetração profunda se o formato não for esse.", "Prometer que substitui todos os vibradores.", "Dizer que todo mini vibrador é fraco.", "Ignorar bateria, material e modos."], correctIndex: 0 },
          { question: "Explique a diferença entre indicar um mini vibrador e indicar uma varinha mágica.", expectedAnswer: "Mini vibrador: pequeno, discreto, vibração mais leve, fácil de guardar. Varinha mágica: maior, mais potente, área de contato grande, indicado para quem quer estímulo forte." },
        ],
      },
    ],
  },
