...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    subtasks: [
      ...
      {
        id: "produtos.prova_final.objetiva",
        kind: "practice",
        title: "Prova Final — Múltipla Escolha (66 questões)",
        description:
          "Prova final do módulo Decorar Principais Produtos. 3 questões objetivas por categoria (22 categorias). Correção automática — você vê quantas acertou ao final. Sem nota mínima.",
        questions: [
      ...
      {
        id: "produtos.prova_final.abertas",
        kind: "open_evaluation",
        title: "Prova Final — Questões Abertas (22 questões)",
        description:
          "Última etapa do módulo. 1 questão aberta por categoria (22 categorias). As respostas vão para correção do admin, seguindo o padrão das provas dissertativas do app.",
        questions: [
